...
## Project Structure
    ...
    ├── sparkling_recipe_de_98767  # Django project configurations
...
1. Clone this repo and `cd sparkling_recipe_de_98767`
...
2. Clone this repo and `cd sparkling_recipe_de_98767`
